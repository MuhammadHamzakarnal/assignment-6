  ...
  return (
    <div className="flex flex-col lg:flex-row justify-between ">
      <div className="w-full lg:w-[500px] mt-16  lg:mt-64 lg:ml-20">
        <h1
          className={`${roboto.className} max-sm:text-center font-bold text-[32px] sm:text-[48px] lg:text-[56px] w-full`}
        >
          Learn new skills online with ease
        </h1>
        <p
          className={`${roboto.className} max-sm:text-center mt-6 text-[16px] lg:text-[18px] w-full lg:w-[500px]`}
        >
