...
const Hero = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-between">
      {/* Left Section */}
      <div className="w-full lg:w-[640px] mt-16 mx-4 lg:mt-64 lg:ml-20">
        <h1
        ...
        <p
          className={`${roboto.className} mt-6 sm:text-[16px] lg:text-[18px] w-full lg:w-[500px]`}
        >
        ...
        <div className="flex flex-col sm:flex-row mt-7">
          <button
            className={`${roboto.className} text-[16px] font-normal w-auto h-auto rounded-[5px] border px-[24px] py-[12px] text-white bg-black mb-4 sm:mb-0 sm:mr-4`}
          >
            Start learning now
          </button>
          <button
